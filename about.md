...
###### 2015.06-至今 即时通许系统(比较市面最后选择了一个开源项目进行二次开发)(c++ linux java objc php socket epoll libevent pthread ProtocolBuffers mysql redis)
...
###### 2015.12-2016.01 即时通讯系统web端的实现(c++ html5 javascript aes websocket ProtocolBuffers)
